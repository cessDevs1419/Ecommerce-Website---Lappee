...
@Component({
  selector: 'app-admin-order-shipping',
  templateUrl: './admin-order-shipping.component.html',
  styleUrls: ['./admin-order-shipping.component.css']
})
export class AdminOrderShippingComponent {
...
ngOnInit(): void{
  this.orders = this.refreshData$.pipe(
          startWith(undefined), 
          switchMap(() => this.service.getAdminOrdersShipping()),
