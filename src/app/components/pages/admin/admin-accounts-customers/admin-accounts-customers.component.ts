...
@Component({
  selector: 'app-admin-accounts-customers',
  templateUrl: './admin-accounts-customers.component.html',
  styleUrls: ['./admin-accounts-customers.component.css']
})
export class AdminAccountsCustomersComponent {
