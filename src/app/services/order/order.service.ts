...
export class OrderService {
  ...
  getReturnList(): Observable<any> {
    return this.http.get(GETReturnIndex);
  }
  ...
  patchOrderReturnConfirm(data: FormData): Observable<any> {
    return this.http.patch(PATCHReturnConfirm, data, this.httpOptions);
  }

  patchOrderReturnViewed(data: FormData): Observable<any> {
    return this.http.post(POSTCompleteReturn, data, this.httpOptions);
  }
  


  patchReturnOrderInitiate(data: FormData): Observable<any> {
    return this.http.patch(PATCHReqReturn, data, this.httpOptions);
  }

  postShippingProof(data: FormData): Observable<any> {
    return this.http.post(POSTConfirmTransit, data, this.httpOptions);
  }
